    ...
    return(
      <div>
        ...
        <div className="forum-description">
          <p className = "forum-text-top">Science and technology are the tools of liberation. With those tools, we can collectively build a path to the future. Therefore, people of color, and sympathetic people of good will, must seize and construct that path or equality will remain just a dream deferred. This forum is meant to be a place to discuss their findings from the search engine, to ask questions, and address on a political level the inequalities they may be experiencing.
